...
const DiabetesForm = () => {
  ...
  return (
    ...
    {showSpan && (
          <div id="prediction" className="pt-0 pb-10 text-center text-black text-3xl md:text-5xl bg-pri font-mono font-normal">
            {result ? <p>{result}</p> : <p>Please fill out each field in the form completely</p>}
          </div>
        )}
    </div>
  );
